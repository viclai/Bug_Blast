...
int StudentWorld::init()
{
	...
	result = m_lvl->loadLevel(file, "levels");
...
bool StudentWorld::allZumiDead() // Problem: Exit appears as visible after killing 2 Zumis
{
	int size = (int)m_actors.size();
	for (int i = 0; i < size; i++)
	{
